    ...
    useEffect(() => {
        const fetchUserCurrentLoans = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                const shelfCurrentLoansesponseJson = await shelfCurrentLoansResponse.json();
                setShelfCurrentLoans(shelfCurrentLoansesponseJson);
            }
        ...
        <div>
            ...
            <div className='d-none d-lg-block mt-2'>
                {shelfCurrentLoans.length > 0 ?
                    ...
                    : // now = 0 or is less than 0 (bug from backend)
                    <>
                        <h3 className='mt-3'>
                            Currently no loans
                        </h3>
            ...
            <div className='container d-lg-none mt-2'>
                {shelfCurrentLoans.length > 0 ?
                    <>
                        <h5 className='mb-3'>Curent Loans: </h5>
                        ...
                        {shelfCurrentLoans.map(shelfCurrentLoan => (
                            <div key={shelfCurrentLoan.book.id}>
                                ...
                                <div className='card d-flex mt-5 mb-3'>
                                    <div className='card-body contaier'>
                                        <div className='mt-3'>
                                            <h4>Loan Options</h4>
                                            {shelfCurrentLoan.daysLeft > 0 &&
                                                <p className='text-secondary'>
