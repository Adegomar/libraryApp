...
export const StarsReview: React.FC<{ rating: number, size: number }> = (props) => {
    ...
    return (
        ...
        <div>
            {/* tu musimy zrobić coś takiego, że trzymamy w _ klucze. _ oznacza, że iterujemy przez nic
            a i to iterator. Czyli iterujemy 3 razy po kluczu "null" z i jako iteratorem */}
